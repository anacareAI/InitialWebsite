    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-foreground/70 text-sm md:text-base max-w-sm">
          Four simple steps to surgical cost transparency and better outcomes for your members.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-green-100 dark:bg-green-900 border-2 border-green-400 dark:border-green-600 p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-green-700 via-emerald-500 to-transparent dark:from-green-500 dark:via-emerald-400 from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
